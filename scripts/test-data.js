...
(function () {
    ...
    const testTasks = [
        // MONDAY
        {
            ...
            hierarchy: ['HEALTH', 'Wellness', 'Meditation'],
            duration: 30,
            day: 'monday',
            time: '08:00',
            notes: '[ ] 5min breathing\n[ ] 10min focus\n[ ] 15min silence',
        },
        {
            title: 'Email Review',
            hierarchy: ['WORK', 'Admin'],
            duration: 60,
            day: 'monday',
            time: '09:00',
            notes: '',
        },
        {
            ...
            hierarchy: ['WORK', 'Projects', 'App Dev'],
            duration: 120,
            day: 'monday',
            time: '10:00',
        ...
        {
            title: 'Design Review',
            hierarchy: ['WORK', 'Projects', 'Design'],
            duration: 90,
            day: 'tuesday',
            time: '11:00',
        ...
        },
        {
            ...
            hierarchy: ['LEARNING', 'Languages', 'Spanish'],
            duration: 60,
            day: 'tuesday',
            time: '15:00',
        ...
        {
            title: 'Yoga',
            hierarchy: ['HEALTH', 'Wellness', 'Yoga'],
            duration: 60,
            day: 'wednesday',
            time: '07:00',
            notes: '',
        ...
        },
        {
            ...
            hierarchy: ['PERSONAL', 'Hobbies', 'Music'],
            duration: 45,
            day: 'wednesday',
            time: '16:00',
            notes: '[ ] Scales\n[ ] New piece\n[ ] Improvisation',
        ...
        {
            title: 'Evening Walk',
            hierarchy: ['HEALTH', 'Fitness', 'Cardio'],
            duration: 30,
            day: 'wednesday',
            time: '18:00',
            notes: '',
        ...
        },
        {
            ...
            hierarchy: ['WORK', 'Social Media', 'YouTube'],
            duration: 120,
            day: 'thursday',
            time: '14:00',
        ...
        {
            title: 'German Lesson',
            hierarchy: ['LEARNING', 'Languages', 'German'],
            duration: 60,
            day: 'thursday',
            time: '17:00',
            notes: '',
        ...
        },
        {
            ...
            hierarchy: ['PERSONAL', 'Hobbies', 'Writing'],
            duration: 90,
            day: 'friday',
            time: '15:00',
            notes: '[ ] Outline\n[ ] First draft\n[ ] Revision',
        ...
        {
            title: 'Meal Prep',
            hierarchy: ['HEALTH', 'Nutrition'],
            duration: 120,
            day: 'saturday',
            time: '11:30',
            notes: '[ ] Prep vegetables\n[ ] Cook proteins\n[ ] Portion meals\n[ ] Store in fridge',
        },
        {
            title: 'Photography',
            hierarchy: ['PERSONAL', 'Hobbies', 'Photography'],
            duration: 120,
            day: 'saturday',
            time: '14:00',
            notes: '',
        ...
        {
            title: 'Sleep In',
            hierarchy: ['HEALTH', 'Wellness', 'Rest'],
            duration: 60,
            day: 'sunday',
            time: '09:00',
            notes: '',
        ...
        },
        {
            ...
            day: 'sunday',
            time: '14:00',
            notes: '[ ] Review calendar\n[ ] Set priorities\n[ ] Block time\n[ ] Prep materials',
        },
        {
            title: 'Learning Session',
            hierarchy: ['LEARNING', 'Online Courses'],
            duration: 120,
            day: 'sunday',
            time: '15:30',
            notes: '[ ] Watch lectures\n[ ] Take notes\n[ ] Practice exercises',
        },
        {
            title: 'Relaxation',
            hierarchy: ['HEALTH', 'Wellness', 'Rest'],
