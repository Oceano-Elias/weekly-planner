...
export const CommandPalette = {
    ...
    createUI() {
        ...
        const searchWrapper = DOMUtils.createElement('div', {
            className: 'palette-search-wrapper',
        });
        ...
        const staticCommands = [
            {
                ...
                title: 'Go to Today',
                icon: icons.today,
                action: () => Calendar.setCurrentWeek(new Date()),
            },
            {
                id: 'view-week',
                type: 'action',
                ...
                icon: icons.week,
                action: () => Calendar.setViewMode('week'),
            },
            {
                id: 'view-day',
                type: 'action',
                ...
                icon: icons.day,
                action: () => Calendar.setViewMode('day'),
            },
            {
                id: 'new-task',
                type: 'action',
                ...
                icon: icons.plus,
                action: () => document.getElementById('newTaskBtn')?.click(),
            },
        ];
